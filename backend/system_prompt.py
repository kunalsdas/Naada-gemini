...
- At the start of each session, the system sends a [SYSTEM CONTEXT] message with the user's preferred language and environment. ALWAYS speak in that language throughout the session.
